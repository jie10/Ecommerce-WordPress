 ...
 * Init Wow effect
 */
if ($('body').hasClass('nasa-enable-wow') && !$('body').hasClass('nasa-in-mobile')) {
    wow_enable = true;
...
$('body').on('nasa_after_changed_tab_content', function(ev, currentTab) {
    if (typeof wow_enable !== 'undefined' && wow_enable && $(currentTab).length) {
        ...
        if ($(currentTab).find('.nasa-slick-slider .wow').length) {
            $(currentTab).find('.nasa-slick-slider .wow').removeClass('nasa-visible');
            _has_slide = true;
        }
        
        setTimeout(function() {
            $(currentTab).find('.wow').css({

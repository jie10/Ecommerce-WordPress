		...
		<div class="landing-container">
			<div class="premium-cta">
				<p>
					...
					echo sprintf( esc_html__( 'Upgrade to %1$spremium version%2$s of %1$sYITH WooCommerce Compare%2$s to benefit from all features!', 'yith-woocommerce-compare' ), '<span class="highlight">', '</span>' );
					?>
				</p>
		...
		<div class="landing-container">
			<div class="col-2">
				...
				<p>
					<?php
					// translators: placeholders are used for add <b> html tag.
					echo sprintf( esc_html__( 'Give a personal touch to the %1$scomparison table%2$s your users will see. Select an image, upload it from the option panel and show it ahead of the table to your users. ', 'yith-woocommerce-compare' ), '<b>', '</b>' );
					?>
				</p>
			</div>
			<div class="col-1">
		...
		<div class="landing-container">
			<div class="col-2">
				...
				<p>
					<?php
					// translators: placeholders are used for add <b> html tag.
					echo sprintf( esc_html__( 'One of the most appealing features of the premium version of the plugin.Four social network sites for your users (Facebook, Twitter, Google + and Pinterest) and the email system %1$sto share%2$s the comparison table of the products they have selected.', 'yith-woocommerce-compare' ), '<b>', '</b>' );
					?>
				</p>
			</div>
			<div class="col-1">
		...
		<div class="landing-container">
			<div class="col-2">
				...
				<p>
					<?php
					// translators: placeholders are used for add <b> html tag.
					echo sprintf( esc_html__( 'An advanced option panel that let you change all the colors of the plugin, so that you can adapt stylistically all its elements %1$sto the layout%2$s of your shop.We know it, looks also count... and we give you the right tools to get to the best result.', 'yith-woocommerce-compare' ), '<b>', '</b>' );
					?>
				</p>
			</div>
			<div class="col-1">
		...
		<div class="landing-container">
			...
			<div class="col-2">
				...
				<p>
					<?php
					// translators: placeholders are used for add <b> html tag.
					echo sprintf( esc_html__( 'Let you users compare products following every feature, and considering also all those %1$sattributes%2$s that can be manually created in within the product detail page. Every single detail will be included.', 'yith-woocommerce-compare' ), '<b>', '</b>' );
					?>
				</p>
			</div>
		</div>
		...
		<div class="landing-container">
			<div class="col-2">
				...
				<p>
					<?php
					// translators: placeholders are used for add <b> html tag.
					echo sprintf( esc_html__( 'Select the products you want to compare and the system will offer you the %1$sshortcode%2$s to generate a comparing table. Simple, rapid and useful.', 'yith-woocommerce-compare' ), '<b>', '</b>' );
					?>
				</p>
			</div>
			<div class="col-1">
		...
		<div class="landing-container">
			...
			<div class="col-2">
				...
				<p>
					<?php
					// translators: placeholders are used for add <b> html tag.
					echo sprintf( esc_html__( 'Thanks to YITH WooCommerce Comapre Widget users could verify at any time the complete list of products added to the compare tab and avoid to open the popup to check its existence. ', 'yith-woocommerce-compare' ), '<b>', '</b>' );
					?>
				</p>
			</div>
		</div>
		...
		<div class="landing-container">
			<div class="col-2">
				...
				<p>
					<?php
					// translators: placeholders are used for add <b> html tag.
					echo sprintf( esc_html__( 'Moreover, if you want to give your users the chance to see in a glance how many products they have added to the Compare list, feel free to use the widget or the shortcode included. And their Compare list is always no more than one click away.', 'yith-woocommerce-compare' ), '<b>', '</b>' );
					?>
				</p>
			</div>
			<div class="col-1">

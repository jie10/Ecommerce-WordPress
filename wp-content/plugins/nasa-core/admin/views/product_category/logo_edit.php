...
<tr class="form-field nasa-term-root-child <?php echo $this->_cat_logo_flag . ' nasa-term-' . $this->_cat_logo_flag . '-on'; ?> hidden-tag">
    ...
    <td>
        <div id="nasa-logo_thumbnail" style="float: left; margin-right: 10px;">
            <img src="<?php echo esc_url($logo); ?>" height="60" />
        </div>
...
<tr class="form-field nasa-term-root-child <?php echo $this->_cat_logo_flag . ' nasa-term-' . $this->_cat_logo_flag . '-on'; ?> hidden-tag">
    <th scope="row" valign="top"><label><?php _e('Override Logo Sticky', 'nasa-core'); ?></label></th>
    <td>
        <div id="nasa-logo-sticky_thumbnail" style="float: left; margin-right: 10px;">
            <img src="<?php echo esc_url($logo_sticky); ?>" height="60" />
        </div>
        <div style="line-height: 60px;">
...
<tr class="form-field nasa-term-root-child <?php echo $this->_cat_logo_flag . ' nasa-term-' . $this->_cat_logo_flag . '-on'; ?> hidden-tag">
    <th scope="row" valign="top"><label><?php _e('Override Logo Mobile', 'nasa-core'); ?></label></th>
    <td>
        <div id="nasa-logo-m_thumbnail" style="float: left; margin-right: 10px;">
            <img src="<?php echo esc_url($logo_m); ?>" height="60" />
        </div>
        <div style="line-height: 60px;">

...
class cmb_Meta_Box_field {
    ...
    public function get_data($field_id = '', $args = array()) {
        ...
        $data = 'options-page' === $type ? cmb_Meta_Box::get_option($id, $field_id) : get_metadata($type, $id, $field_id, ($single || $repeat) /* If multicheck this can be multiple values */);
    ...
    public function remove_data($old = '') {
        ...
        return 'options-page' === $type ? cmb_Meta_Box::remove_option($id, $field_id) : delete_metadata($type, $id, $field_id, $old);
    }
    ...
    public function render_field() {
        ...
        if (!NASA_CORE_IN_ADMIN && !$this->args('on_front')) {
            return;
        }
    ...
    public function _set_field_defaults($args) {
        ...
        $args['options'] = 'group' == $args['type'] ? wp_parse_args($args['options'], array(
            'add_button' => esc_html__('Add Group', 'nasa-core'),
            'remove_button' => esc_html__('Remove Group', 'nasa-core'),
        )) : $args['options'];

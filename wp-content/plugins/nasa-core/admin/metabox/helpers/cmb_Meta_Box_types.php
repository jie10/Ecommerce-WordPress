...
class cmb_Meta_Box_types {
    ...
    public function is_valid_img_ext($file) {
        ...
        $this->valid = empty($this->valid) ? (array) apply_filters('cmb_valid_img_types', array('jpg', 'jpeg', 'png', 'gif', 'ico', 'icon')) : $this->valid;
    ...
    public function render_repeatable_field() {
        ...
        <p class="add-row">
            <a data-selector="<?php echo $table_id; ?>" class="add-row-button button" href="#"><?php esc_html_e('Add Row', 'nasa-core'); ?></a>
        </p>
    ...
    protected function repeat_row($class = 'repeat-row') {
        ...
        <tr class="<?php echo $class; ?>">
            ...
            <td class="remove-row">
                <a class="button remove-row-button" href="#">
                    <?php esc_html_e('Remove', 'nasa-core'); ?>
                </a>
            </td>
        </tr>
    ...
    public function taxonomy_select() {
        ...
        $terms = get_terms(apply_filters('woocommerce_product_attribute_terms', array('taxonomy' => $this->field->args('taxonomy'), 'hide_empty' => false)));
        $options = '';
    ...
    public function taxonomy_radio() {
        ...
        if (!$terms) {
            $options .= '<li><label>' . esc_html__('No terms', 'nasa-core') . '</label></li>';
        } else {
            foreach ($terms as $term) {
                $args = array(
                    'value' => $term->slug,
    ...
    public function file_list() {
        ...
        $this->input(array(
            ...
            'value' => esc_html__('Add or Upload File', 'nasa-core'),
            'name' => '', 'id' => '',
        ));
        ...
        if ($meta_value && is_array($meta_value)) {
            ...
            foreach ($meta_value as $id => $fullurl) {
                ...
                if ($this->is_valid_img_ext($fullurl)) {
                    ...
                    '<p class="cmb_remove_wrapper"><a href="#" class="cmb_remove_file_button">' . esc_html__('Remove Image', 'nasa-core') . '</a></p>
						' . $id_input . '
					</li>';
                } else {
                    ...
                    echo
                    '<li>',
                    esc_html__('File:', 'nasa-core'), ' <strong>', $title, '</strong>&nbsp;&nbsp;&nbsp; (<a href="', $fullurl, '" target="_blank" rel="external">' . esc_html__('Download', 'nasa-core') . '</a> / <a href="#" class="cmb_remove_file_button">' . esc_html__('Remove', 'nasa-core') . '</a>)
						' . $id_input . '
					</li>';
                }
            }
    ...
    public function file() {
        ...
        '<input class="cmb_upload_button button" type="button" value="' . esc_html__('Add or Upload File', 'nasa-core') . '" />',
        $this->_desc(true);
        ...
        if (!empty($meta_value)) {
            ...
            if ($this->is_valid_img_ext($meta_value)) {
                ...
                echo '<p class="cmb_remove_wrapper"><a href="#" class="cmb_remove_file_button" rel="', $cached_id, '">' . esc_html__('Remove Image', 'nasa-core') . '</a></p>';
                echo '</div>';
            } else {
                ...
                echo esc_html__('File:', 'nasa-core'), ' <strong>', $title, '</strong>&nbsp;&nbsp;&nbsp; (<a href="', $meta_value, '" target="_blank" rel="external">' . esc_html__('Download', 'nasa-core') . '</a> / <a href="#" class="cmb_remove_file_button" rel="', $cached_id, '">' . esc_html__('Remove', 'nasa-core') . '</a>)';
            }
        }
        echo '</div>';
    }

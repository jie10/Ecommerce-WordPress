 ...
 */
class Nasa_Sliders_WGSC extends Nasa_Elementor_Widget {
    ...
    function __construct() {
        ...
        $this->widget_cssclass = 'woocommerce nasa_sliders_wgsc';
        $this->widget_description = esc_html__('Displays Shortcode Nasa Sliders with Banner', 'nasa-core');
        $this->widget_id = 'nasa_sliders_sc';
        $this->widget_name = esc_html__('Nasa Sliders', 'nasa-core');
        $this->settings = array(
            'title' => array(
                'type' => 'text',
                'std' => '',
        ...
        add_action('nasa_widget_field_sliders', array($this, 'sliders_content'), 10, 4);

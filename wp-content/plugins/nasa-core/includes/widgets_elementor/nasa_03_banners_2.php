...
class Nasa_Banner_2_WGSC extends Nasa_Elementor_Widget {
    ...
    function __construct() {
        ...
        $this->widget_description = esc_html__('Display Banner v2', 'nasa-core');
        $this->widget_id = 'nasa_banner_2_sc';
        $this->widget_name = esc_html__('Nasa Banner v2', 'nasa-core');
        $this->settings = array(
            'img_src' => array(
                'type' => 'attach_image',
                'std' => '',
            ...
            'content' => array(
                'type' => 'textarea',
                'std' => '',
                'label' => esc_html__('Banner Content', 'nasa-core')
            ),

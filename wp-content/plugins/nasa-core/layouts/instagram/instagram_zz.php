...
$class = 'nasa-instagram nasa-instagram-ziczac';
...
echo '<div class="nasa-intagram-wrap' . ($el_class != '' ? ' ' . $el_class : '') . '" data-layout="ziczac" data-size="' . $width . '">';
...
for ($i = 0; $i < $limit_items; $i++) :
    ...
    $liclass .= ($i+1)%2 == 1 ? ' nasa-odd' : ' nasa-even';
